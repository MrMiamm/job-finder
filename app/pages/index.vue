<template>
  <ContainersSearchBar v-model="searchBar" class="mb-6" />
  <div class="w-full flex flex-col items-center">
    ...
    <Icon v-else-if="searchBar.status === 'pending'" name="eos-icons:three-dots-loading" size="96" />
    
  </div>
</template>

<script lang="ts" setup>
import type { SearchResult } from '~/components/containers/SearchBar.vue';
